/**
 * ============================================================
 * STEP 7 — PEACH SYSTEM CREATIVE AI ANALYSIS + BRIEFS
 ...
 *   creative_output_table   tblq6OICv2BlU0Nek  (this week's ads)
...
export default {
  ...
  async fetch(request, env, ctx) {
    ...
    if (url.pathname === '/health') {
      return Response.json({ status: 'ok', step: 7, worker: 'step-7-peach-system-creative-analysis' });
    }
    if (url.pathname === '/run') {
      ctx.waitUntil(runCreativeAnalysis(env));
